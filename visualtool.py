...
def Initialize(outcarfile, trans_df, Enmin, Enmax, cbandmin, cbandmax,vbandmin,vbandmax, klist):
    ...
    k_df=pd.read_csv(outcarfile,skiprows=kpt_ln+1,nrows=kpoint_number,delim_whitespace=True,usecols=[0,1,2],names=["xcoord","ycoord","zcoord"]) #read in the locations of k-points as a dataframe
